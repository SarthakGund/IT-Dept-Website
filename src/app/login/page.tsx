...
export default function Page() {
  ...
  return (
    <div className="bg-black p-8 text-center text-white h-screen flex flex-col justify-center items-center w-[100%]">
      <div className="w-full max-w-[600px]">
        <h2 className="mb-6 text-3xl font-bold">Welcome Back</h2>
        <form className="w-[600px] flex items-center flex-col">
          <div className="mb-6">
            <label
              htmlFor="email"
